...
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT USAGE ON TYPES TO mini_dish_db_manager;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT INSERT, SELECT, DELETE, UPDATE ON TABLES TO mini_dish_db_manager;
ALTER DEFAULT PRIVILEGES IN SCHEMA public GRANT SELECT, UPDATE ON SEQUENCES TO mini_dish_db_manager;
